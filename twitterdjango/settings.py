...
SECRET_KEY = '3hq=ez6#e=59(6&e_rg^0br^boc5_4isw@k5+2x1+^wfdz$r5l'
...
STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'twitterdjango/static')
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'twitterdjango/static')]
